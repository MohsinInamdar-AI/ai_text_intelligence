...
This service uses lazy loading to prevent import-time failures
in CI/CD pipelines and Docker environments.
"""
...
_nlp = None  # Cached spaCy model instance
...
def extract_keywords(text: str, top_k: int = 5):
    """
    Extract top keywords using spaCy noun chunks.
    """
    nlp = get_nlp()
    doc = nlp(text)
